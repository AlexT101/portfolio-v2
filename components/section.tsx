...
export default function Section({
    ...
    return (
        <section
            id={root}
            className="w-full bg-black max-w-6xl p-6 sm:p-12 py-12 sm:py-20 border-x border-b border-zinc-800 flex flex-col"
        >
            ...
            <h2
                ...
                className="-ml-6 sm:-ml-12 pl-4 sm:pl-10 text-3xl sm:text-5xl font-semibold text-zinc-400"
            >
            ...
            <EmblaCarousel
                slides={
                    root && slideCount ? generateSlidePaths(root, slideCount) : ["placeholder.png"]
                }
                options={{}}
                priority={priority}
            />
            <div className="w-full flex flex-col md:flex-row gap-10">
                ...
                <div className="md:w-0 md:flex-1 text-zinc-400 text-base sm:text-lg leading-relaxed">
                    {addLineBreak(fullDescription)}
                </div>
            </div>
        </section>
    );
