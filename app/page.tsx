  ...
  return (
    <main className="w-full bg-black flex flex-col items-center">
      ...
      <Section
        ...
        fullDescription="I designed and led the development of a website to help the GTXR club run the ImmerseGT hackathon. The platform had a landing page with details about the event as well as a registration portal, which facilitated over 200 signups. The website also had in-development functionality for a team formation tool which would help organize the team finding process during the hackathon, since users could create teams and search for open teams to join. \nUnfortunately the hackathon could not be held during the 2024 hackathon season due to logistics issues, the platform is ready for extended use next year."
        accentColor="#CC5DE8"
      />
      ...
      <Section
        ...
        fullDescription="I worked with 3 people to create GreenJournal for a 36 hour hackathon, HackGT X, held at Georgia Tech. Our goal was to devise an easy, visual, and interactive way for people to track their impact on the environment through their carbon footprint. We did this with procedures and data we found on the Environmental Protection Agency website, which we used to calculate each of the top factors that affect one’s carbon footprint. One of our team members designed the globe in Blender and used Three.js to make it visually responsive to the collected user data as we identified their carbon footprint as either better or worse than average human behaviors. \nI was responsible for designing the initial wireframe layout and working on various parts of the user interface. I also handled user input by creating input fields using the NextUI component library and writing the algorithms necessary to calculate the carbon footprint."
        accentColor="#18C964"
      />
      ...
      <Section
        ...
        fullDescription="I worked with 3 people to create MarketMatch for a 36 hour hackathon, Hacklytics 2024, at Georgia Tech. Our goal was to build a beginner-friendly website to introduce people to the stock market. \nOur website lets users input preferences about the types of stocks they would like to see. We then provide them one recommendation at a time (similar to a Tinder profile) with detailed information about the stock including a description, graphs, detailed data, sentiment analysis based on the news, and a chatbot integration if users have any questions. Users can then swipe left (to reject) or right (to accept) the stock, adding it to their tailored portfolio. We send their swipe choice to the backend to tailor future recommendations to their preferences using machine learning. \nMy teammates were responsible for building the backend and recommendation algorithms, and I was responsible for developing the frontend."
        accentColor="#3B5BDB"
      />
      ...
      <Section
        ...
        fullDescription="I worked with 5 people to create Wrapped for the class CS 2340: Objects and Design at Georgia Tech. Our Android app is based on Spotify Wrapped, but available year round. The user can choose a time range across their listening history, and we generate several slides (like an Instagram story) to show various aspects of their listening, such as their top tracks and artists. \nWe get this data from the Spotify Web API, and we use Firebase to store user data and handle authentication so the generated information is available from any device they log in to."
        accentColor="#bf3f5c"
      />
      ...
      <Section
        ...
        fullDescription="I worked with 2 people to create the College Scheduler Android app for the CS2340 class. The app lets students add their classes, assignments, exams, and upcoming tasks they need to work on to the app. There is also functionality for sorting and filtering items. \nThis project was a practice assignment so there is no backend functionality for user accounts or storing their inputted data."
        accentColor="#BDB2FF"
      />
      ...
      <Section
        ...
        purpose="Practice"
        fullDescription="Lifts (image 1) is a UI/UX mockup for a mobile app to let bodybuilders and powerlifters track their fitness journey. Users can start a workout and log individual lifts, such as bench press or deadlift, to track their numbers and progress over time. \nAgent (image 2) is a UI/UX mockup for an informational webpage for the game Valorant. I am not affiliated with Riot/Valorant, but I wanted to practice working with their design style of utilitarian, yet clean and appealing, graphics. The current page displays information about Sova, an agent in the game. I used official Valorant assets, as well their current website’s color scheme and similar fonts."
        accentColor="#ffffff"
      />
